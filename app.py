...
def show_report_page(page):
    ...
    page.add(
        ft.Container(
            content=ft.Image(src="https://www.example.com/path-to-your-report-background.jpg", fit=ft.ImageFit.COVER),
            expand=True
        )
    )
...
def load_main_page(page):
    ...
    page.add(
        ft.Container(
            content=ft.Image(src="https://www.example.com/path-to-your-finance-background.jpg", fit=ft.ImageFit.COVER),
            expand=True
        )
    )
